  ...
  return (
    <div className="flex flex-col md:flex-row p-4 justify-around items-center bg-[#0051d8]">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-center items-center">
        <TiHome className="text-[white] text-xl md:text-2xl cursor-pointer" />
        <ul className="flex flex-col md:flex-row gap-2 md:gap-4 justify-center items-center">
          <span className="text-[#627591]">/</span>
          <li className="text-[white] font-semibold text-sm md:text-base cursor-pointer hover:border-b-[1.5px] border-[white]">DataSets</li>
          <li className="bg-[white] p-2 text-[#4378cf] font-semibold text-sm md:text-base cursor-pointer">
            Organization
          </li>
        </ul>
      </div>
